...
class DetailPurchaseReceiptsControllerTest < ActionController::TestCase
  ...
  test "should create detail_purchase_receipt" do
    assert_difference('DetailPurchaseReceipt.count') do
      post :create, detail_purchase_receipt: { cantidad: @detail_purchase_receipt.cantidad, product_id: @detail_purchase_receipt.product_id, purchase_receipt_id: @detail_purchase_receipt.purchase_receipt_id, valor_total: @detail_purchase_receipt.valor_total }
    end
  ...
  test "should update detail_purchase_receipt" do
    patch :update, id: @detail_purchase_receipt, detail_purchase_receipt: { cantidad: @detail_purchase_receipt.cantidad, product_id: @detail_purchase_receipt.product_id, purchase_receipt_id: @detail_purchase_receipt.purchase_receipt_id, valor_total: @detail_purchase_receipt.valor_total }
    assert_redirected_to detail_purchase_receipt_path(assigns(:detail_purchase_receipt))
  end
