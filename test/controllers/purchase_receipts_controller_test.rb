...
class PurchaseReceiptsControllerTest < ActionController::TestCase
  ...
  test "should create purchase_receipt" do
    assert_difference('PurchaseReceipt.count') do
      post :create, purchase_receipt: { cantidad: @purchase_receipt.cantidad, costo_unitario: @purchase_receipt.costo_unitario, fecha: @purchase_receipt.fecha, numero_factura: @purchase_receipt.numero_factura, product_id: @purchase_receipt.product_id, provider_id: @purchase_receipt.provider_id, valor_total: @purchase_receipt.valor_total }
    end
  ...
  test "should update purchase_receipt" do
    patch :update, id: @purchase_receipt, purchase_receipt: { cantidad: @purchase_receipt.cantidad, costo_unitario: @purchase_receipt.costo_unitario, fecha: @purchase_receipt.fecha, numero_factura: @purchase_receipt.numero_factura, product_id: @purchase_receipt.product_id, provider_id: @purchase_receipt.provider_id, valor_total: @purchase_receipt.valor_total }
    assert_redirected_to purchase_receipt_path(assigns(:purchase_receipt))
  end
